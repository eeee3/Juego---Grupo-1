...
while not hecho:
    ...
    texto = fuente.render("Puntuacion: %d" % (puntuacion), 0, (0,0,0))

    salud = fuente.render("Salud: ", 0, (0,0,0))

    mana = fuente.render("Mana: %d" %(protagonista.mana), 0, (0,0,0))

    oro = fuente.render("Oro: %d" %(protagonista.oro), 0, (0,0,0))
