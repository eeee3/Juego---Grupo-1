...
vendedor1 = Vendedor(AZUL, 50,50,100,100)

vendedor2 = Vendedor(AZUL, 50,50,100,200)
...
while not hecho:
    ...
    if vendedor1.rect.y < protagonista.hitbox[1] + protagonista.hitbox[3] and vendedor1.rect.y > protagonista.hitbox[1]:
        if vendedor1.rect.x > protagonista.hitbox[0] and vendedor1.rect.x < protagonista.hitbox[0] + protagonista.hitbox[2]: 
            offset_x = 0
            offset_y = 0
