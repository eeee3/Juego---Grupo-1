    ...
    def update(self):
        ...
        if self.attack_up_token == 1:
            ...
            if self.ataque_bucle == 1:
                self.image = pygame.image.load("ataque/attack-back-1.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 2:
                self.image = pygame.image.load("ataque/attack-back-2.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 3:
                self.image = pygame.image.load("ataque/attack-back-3.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 4:
                self.image = pygame.image.load("ataque/attack-back-4.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 5:
                self.image = pygame.image.load("ataque/attack-back-5.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 6:
                self.image = pygame.image.load("ataque/attack-back-6.bmp").convert()
                self.image.set_colorkey(BLANCO)
            else:
                self.ataque_bucle = 1
        ...
        if self.attack_down_token == 1:
            self.ataque_bucle += 1
            if self.ataque_bucle == 1:
                self.image = pygame.image.load("ataque/attack-front-1.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 2:
                self.image = pygame.image.load("ataque/attack-front-2.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 3:
                self.image = pygame.image.load("ataque/attack-front-3.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 4:
                self.image = pygame.image.load("ataque/attack-front-4.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 5:
                self.image = pygame.image.load("ataque/attack-front-5.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 6:
                self.image = pygame.image.load("ataque/attack-front-6.bmp").convert()
                self.image.set_colorkey(BLANCO)
            else:
                self.ataque_bucle = 0
        ...
        if self.attack_right_token == 1:
            ...
            if self.ataque_bucle == 1:
                self.image = pygame.image.load("ataque/attack-1-right.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 2:
                self.image = pygame.image.load("ataque/attack-2-right.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 3:
                self.image = pygame.image.load("ataque/attack-3-right.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 4:
                self.image = pygame.image.load("ataque/attack-4-right.bmp").convert()
                self.image.set_colorkey(BLANCO)
            else:
                self.ataque_bucle = 0
        ...
        if self.attack_left_token == 1:
            self.ataque_bucle += 1
            if self.ataque_bucle == 1:
                self.image = pygame.image.load("ataque/attack-1.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 2:
                self.image = pygame.image.load("ataque/attack-2.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 3:
                self.image = pygame.image.load("ataque/attack-3.bmp").convert()
                self.image.set_colorkey(BLANCO)
            elif self.ataque_bucle == 4:
                self.image = pygame.image.load("ataque/attack-4.bmp").convert()
                self.image.set_colorkey(BLANCO)
            else:
                self.ataque_bucle = 0
...
class Proyectil(pygame.sprite.Sprite):
    def __init__(self, posx, posy, ancho1, alto1):
        ...
        self.imageProyectil = pygame.image.load("disparos/flecha-iz.bmp").convert()
