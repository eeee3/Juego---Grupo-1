...
while not hecho:
    ...
    if vendedor1.hitbox[0] < protagonista.hitbox[0]+30 and protagonista.hitbox[0] < vendedor1.hitbox[0]+50 and vendedor1.hitbox[1]+50 == protagonista.hitbox[1]:

        print ("Contacto")

        offset_y = 0
    
    if vendedor1.hitbox[0] < protagonista.hitbox[0]+30 and vendedor1.hitbox[1] < protagonista.hitbox[1] and protagonista.hitbox[1] > vendedor1.hitbox[1]+50:
